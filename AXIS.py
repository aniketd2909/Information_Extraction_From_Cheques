...
cv2.imwrite("date_dialtion.jpg",dilation)
...
a = (350,440,2600,560)          #amount_word
img= im.crop(a) 
...
a=(760,1300,1050,1500) #cheque number
img=im.crop(a)
img.save("cheqno.jpg")
